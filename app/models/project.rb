...
class Project < ApplicationRecord
  ...
  validates :identifier, presence: true, uniqueness: { scope: :locale }, if: :locale
  validates :identifier, presence: true, uniqueness: true, unless: :locale
  ...
  def check_unique_not_null
    ...
    self.identifier = PhraseIdentifier.generate until has_allowed_identifier
  end

  def has_allowed_identifier
    if self.locale.nil?
