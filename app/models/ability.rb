...
class Ability
  ...
  def define_school_owner_abilities(school:)
    ...
    # can(%i[read create create_batch destroy], :class_member, school_class: { school: { id: school.id } })
  ...
  def define_school_teacher_abilities(user:, school:)
    ...
    # can(%i[read create create_batch destroy], :class_member, school_class: { school: { id: school.id }, teachers: { teacher_id: user.id } })
