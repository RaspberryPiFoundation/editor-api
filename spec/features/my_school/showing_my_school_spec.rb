...
RSpec.describe 'Showing my school', type: :request do
  ...
  it "includes the school details and user's roles in the JSON" do
    ...
    expected_data = JSON.parse(school_json, symbolize_names: true).merge(roles: ['owner'], import_in_progress: school.import_in_progress?, sso_enabled: school.sso_enabled?)
