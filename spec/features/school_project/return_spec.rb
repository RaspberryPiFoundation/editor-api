...
RSpec.describe 'School project return requests', type: :request do
  ...
  context 'when logged in as student' do
    before do
      ...
      post("/api/projects/#{student_project.identifier}/return", headers:)
    end
  ...
  context 'when project does not exist' do
    before do
      authenticated_in_hydra_as(student)
      post('/api/projects/does-not-exist/return', headers:)
    end
