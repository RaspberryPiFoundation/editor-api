...
RSpec.describe 'Project show requests', type: :request do
  ...
  context 'when user is logged in' do
    ...
    context 'when loading own project' do
      it 'returns success response' do
        get "/api/projects/#{project.identifier}", headers: headers
    ...
    context 'when loading another user\'s project' do
      ...
      it 'returns forbidden response' do
        get "/api/projects/#{another_project.identifier}", headers: headers
  ...
  context 'when user is not logged in' do
    context 'when loading a starter project' do
      ...
      it 'returns success response' do
        get "/api/projects/#{starter_project.identifier}", headers: headers
      ...
      it 'returns 404 response if invalid project' do
        get '/api/projects/no-such-project', headers: headers
